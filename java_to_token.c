...
int main(void){
	...
	while(ntoken){
		if(lexeme[ntoken][0]=='\0') {
			switch(ntoken)
			{
				case 27 : Id=add(Id); break;
				case 72 : Lit_d=add(Lit_d);break;
				case 73 : Lit_o=add(Lit_o);break;
				case 74 : Lit_h=add(Lit_h); break;
				case 75 : Flo=add(Flo);break;
				case 76 : Cha=add(Cha);break;
				case 77 : Str=add(Str);break;
				default : ;
			}
			//printf("%s hello\n",yytext);
                   }
