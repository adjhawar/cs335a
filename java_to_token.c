...
int main(void){
	...
	int ntoken,vtoken, occur[80]={0};
        ...
        char lexeme[80][15] = {"", "class", "instanceof", "new" , "super" , "this", "boolean", "byte", "char", "double", "float", "int", "long", "short","void","break","case","break","case","default","else","if","switch","continue","do","for","while","return","final","id",",",";",":","[","]","{",
"}","(",")","=","+=","-=","/=","*=","%=","<<=",">>=","&=","=","^=",">>>=","?","&&","||","|","^","&","==","=",">","<",">=","<=",">>","<<","+","-","*","/","%","++","--",".",">>>" };
