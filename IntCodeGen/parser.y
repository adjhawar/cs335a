...
%type <sval>var_decl_id var_declarator name
%type <attr>var_declarators postfix_expr unary_expr_not_plus_minus unary_expr mul_expr add_expr shift_expr rel_expr
%%
